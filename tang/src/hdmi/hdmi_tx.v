...
module hdmi_tx (
    input             I_rst_n      ,
    input             I_rgb_clk    ,   // pixel clock, 40.5 MHz
    input             I_rgb_vs     ,
    input             I_rgb_hs     ,
    input             I_rgb_de     ,
    input       [7:0] I_rgb_r      ,
...
//
// N = 6144 is the standard value for the 48 kHz family; CTS = 40500 puts
// Fs at 40.5e6 * 6144 / (128 * 40500) = 48.000 kHz exactly - the 40.5
// MHz pixel clock of Korvet Nano - and the 48 kHz in the channel status
// is true.  (PK8000 Nano's 30 MHz took CTS 30000; UKNC Nano's 50.14 MHz
// needed 50140, and the text above is its story.)
//------------------------------------------------------------------------
localparam [19:0] ACR_N   = 20'd6144 ;
localparam [19:0] ACR_CTS = 20'd40500;

localparam integer AUD_PERIOD = 128 * 40500;   // 5184000 accumulator wrap
