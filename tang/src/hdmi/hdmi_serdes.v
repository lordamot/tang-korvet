...
// 40.5 MHz x 5 = 202.5 MHz.  VCO = 202.5 x 4 = 810 MHz, inside the GW2A
// range; the phase detector sees the full 40.5 MHz.  (PK8000 Nano ran
// this at 150 MHz from 30, UKNC Nano at 250.7 from 50.143.)  Parameters
