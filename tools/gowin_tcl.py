...
The Gowin IDE keeps what to build in tang/korvet.gprj, and its headless
...
The options come from tang/impl/gwsynthesis/pk8000.prj, which is what the
IDE last wrote:  top module `top`, SystemVerilog 2017 (korvet/ym2149.sv needs
...
def main():
    ...
    cfgp = os.path.join(ROOT, "tang", "impl", "korvet_process_config.json")
