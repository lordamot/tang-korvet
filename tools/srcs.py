...
tang/korvet.gprj is the source of truth for what gets built (see
...
GPRJ = os.path.join(ROOT, "tang", "korvet.gprj")
...
STUBBED = ("src/hdmi/hdmi_serdes.v",
           "src/sys_pll.v",             # a hand-instantiated rPLL, like hdmi_serdes
           "src/korvet/opts_rom.v",   # pROM primitives, generated by bin2prom.py
           "src/korvet/font_rom.v",     # the same, the character generator
           "src/mister/sector_dpram.v", # a DPB wrapper; sd_card.v carries its own model under `ifdef VERILATOR
           "src/mister/sd_card.v",      # the card itself: sim/stubs/sd_card_sim.v serves image files instead
           "src/mister/sd_rw.v",        # (sd_card.v's parts, with it)
           "src/mister/sdcmd_ctrl.v")
